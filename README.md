...
dbt transformations → Python quant risk engine → orchestrated Dagster
...
> my current professional engagements (as of May 2026).

For the modelling write-up (i.e. what each engine actually does), the
...
**Rate model: Hull-White 1F (curve-calibrated with Vasicek also selectable)**
...
- Exact-discretisation Monte Carlo, antithetic variates.
...
**EVE engine: BCBS 368 + Monte Carlo distribution**
...
**NII engine: Monte Carlo paths + behavioural repricing**
...
legacy/               Postgres / SQLAlchemy v1 artefacts (archived from first version)
```
...
[Thomas Martinez](https://thomasmartins.github.io). Built as a public ALM
portfolio piece.
